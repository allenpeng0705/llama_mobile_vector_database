 ...
 */
fun LlamaMobileVD.SearchResult.toKotlin(): LlamaMobileVD.SearchResult {
    return this
}
 ...
 */
fun Array<LlamaMobileVD.SearchResult>.toKotlinList(): List<LlamaMobileVD.SearchResult> {
    return this.toList()
}
 ...
 */
suspend fun createVectorStoreAsync(dimension: Int, metric: LlamaMobileVD.DistanceMetric): Long = 
    withContext(Dispatchers.IO) {
        LlamaMobileVD.createVectorStore(dimension, metric)
    }
 ...
 */
suspend fun searchVectorStoreAsync(storeId: Long, queryVector: FloatArray, k: Int): List<LlamaMobileVD.SearchResult> = 
    withContext(Dispatchers.IO) {
 ...
 */
suspend fun createHNSWIndexAsync(dimension: Int, metric: LlamaMobileVD.DistanceMetric, maxElements: Long): Long = 
    withContext(Dispatchers.IO) {
        LlamaMobileVD.createHNSWIndex(dimension, metric, maxElements)
    }
...
suspend fun createHNSWIndexAsync(
    dimension: Int, 
    metric: LlamaMobileVD.DistanceMetric, 
    maxElements: Long, 
    M: Int, 
    efConstruction: Int, 
    seed: Int = 42
): Long = withContext(Dispatchers.IO) {
    LlamaMobileVD.createHNSWIndex(dimension, metric, maxElements, M, efConstruction, seed)
}
 ...
 */
suspend fun searchHNSWAsync(indexId: Long, queryVector: FloatArray, k: Int): List<LlamaMobileVD.SearchResult> = 
    withContext(Dispatchers.IO) {
 ...
 */
suspend fun createMMapVectorStoreBuilderAsync(dimension: Int, metric: LlamaMobileVD.DistanceMetric): Long = 
    withContext(Dispatchers.IO) {
        LlamaMobileVD.createMMapVectorStoreBuilder(dimension, metric)
    }
 ...
 */
suspend fun searchMMapAsync(storeId: Long, queryVector: FloatArray, k: Int): List<LlamaMobileVD.SearchResult> = 
    withContext(Dispatchers.IO) {
